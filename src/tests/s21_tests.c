...
START_TEST(s21_sscanf_test_21_f_option) {
  ...
  result = s21_sscanf("30.4E+4932", "%lf", &afl);
  result_origin = sscanf("30.4E+4932", "%lf", &cfl);
  ck_assert_int_eq(result, result_origin);
  ck_assert_float_eq(afl, cfl);
}
...
START_TEST(s21_sscanf_test_21_e_option) {
  ...
  result = s21_sscanf("30.4E+92233720368547758071", "%Le", &al);
  result_origin = sscanf("30.4E+92233720368547758071", "%Le", &cl);
  ck_assert_int_eq(result, result_origin);
  ck_assert_float_eq(al, cl);
}
...
START_TEST(sscanf_lf_1) {
  char format[] = "%f %f %f %f";
  char str[] = "-34.5+6e3 83.24444e-140 .4356 +2.43e3";
  float d1, d2;
  float q1, q2;
  float z1, z2;
  float w1 = 0, w2 = 0;
...
int main(void) {
  ...
  tcase_add_test(test_case_1, sscanf_lf_1);
